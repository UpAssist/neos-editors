...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.default = undefined;\n\nvar _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"]) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); } }; }();\n\nvar _dec, _class, _class2, _temp2;\n\nvar _react = __webpack_require__(/*! react */ \"./node_modules/@neos-project/neos-ui-extensibility/dist/shims/vendor/react/index.js\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _propTypes = __webpack_require__(/*! prop-types */ \"./node_modules/@neos-project/neos-ui-extensibility/dist/shims/vendor/prop-types/index.js\");\n\nvar _propTypes2 = _interopRequireDefault(_propTypes);\n\nvar _styles = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n\nvar _styles2 = _interopRequireDefault(_styles);\n\nvar _neosUiDecorators = __webpack_require__(/*! @neos-project/neos-ui-decorators */ \"./node_modules/@neos-project/neos-ui-extensibility/dist/shims/neosProjectPackages/neos-ui-decorators/index.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar ArrayInfoEditor = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {\n\treturn {\n\t\ti18nRegistry: globalRegistry.get('i18n')\n\t};\n}), _dec(_class = (_temp2 = _class2 = class ArrayInfoEditor extends _react.PureComponent {\n\tconstructor() {\n\t\tvar _temp;\n\n\t\treturn _temp = super(...arguments), this.isHtml = function (string) {\n\t\t\treturn (/<\\/?[a-z][\\s\\S]*>/i.test(string)\n\t\t\t);\n\t\t}, _temp;\n\t}\n\n\trender() {\n\t\tvar _this = this;\n\n\t\tvar _props = this.props,\n\t\t    value = _props.value,\n\t\t    options = _props.options,\n\t\t    i18nRegistry = _props.i18nRegistry;\n\n\t\tvar finalOptions = Object.assign({}, this.constructor.defaultOptions, options);\n\t\tvar placeholder = finalOptions.placeholder && i18nRegistry.translate(unescape(finalOptions.placeholder));\n\n\t\treturn _react2.default.createElement(\n\t\t\t'ul',\n\t\t\t{ className: _styles2.default.ArrayInfoEditor },\n\t\t\tvalue.length === 0 && _react2.default.createElement(\n\t\t\t\t'li',\n\t\t\t\t{ className: _styles2.default.ArrayInfoEditor__item },\n\t\t\t\t_react2.default.createElement(\n\t\t\t\t\t'div',\n\t\t\t\t\t{ role: 'button',\n\t\t\t\t\t\tclassName: _styles2.default.ArrayInfoEditor__content },\n\t\t\t\t\tplaceholder !== 'i18n' ? placeholder : 'No values'\n\t\t\t\t)\n\t\t\t),\n\t\t\tvalue && Object.entries(value).map(function (_ref) {\n\t\t\t\tvar _ref2 = _slicedToArray(_ref, 2),\n\t\t\t\t    key = _ref2[0],\n\t\t\t\t    val = _ref2[1];\n\n\t\t\t\treturn _react2.default.createElement(\n\t\t\t\t\t'li',\n\t\t\t\t\t{ key: key, className: _styles2.default.ArrayInfoEditor__item },\n\t\t\t\t\t_react2.default.createElement(\n\t\t\t\t\t\t'div',\n\t\t\t\t\t\t{ className: _styles2.default.ArrayInfoEditor__title },\n\t\t\t\t\t\tkey\n\t\t\t\t\t),\n\t\t\t\t\t_react2.default.createElement(\n\t\t\t\t\t\t'div',\n\t\t\t\t\t\t{ role: 'button', className: _styles2.default.ArrayInfoEditor__content },\n\t\t\t\t\t\t_this.isHtml(val) ? _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: val } }) : val\n\t\t\t\t\t)\n\t\t\t\t);\n\t\t\t})\n\t\t);\n\t}\n}, _class2.propTypes = {\n\tvalue: _propTypes2.default.oneOfType([_propTypes2.default.array]),\n\toptions: _propTypes2.default.object,\n\ti18nRegistry: _propTypes2.default.object.isRequired\n}, _class2.defaultOptions = {\n\treadonly: true,\n\tplaceholder: ''\n}, _temp2)) || _class);\nexports.default = ArrayInfoEditor;\n\n//# sourceURL=webpack:///./src/ArrayInfoEditor.js?");
...
eval("// extracted by mini-css-extract-plugin\nmodule.exports = {\"ArrayInfoEditor\":\"styles__ArrayInfoEditor___3PwM5\",\"ArrayInfoEditor__item\":\"styles__ArrayInfoEditor__item___1qVwM\",\"ArrayInfoEditor__title\":\"styles__ArrayInfoEditor__title___3hPjA\",\"ArrayInfoEditor__content\":\"styles__ArrayInfoEditor__content___19jcM\"};\n\n//# sourceURL=webpack:///./src/styles.css?");
